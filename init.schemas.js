...
window.bricks['brick-experimental-features'].schemasArray = [];

define(window.bricks['brick-experimental-features'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['brick-experimental-features'].schemasArray[i];
        var urlPrefix = 'canopsis/brick-experimental-features/schemas/';
